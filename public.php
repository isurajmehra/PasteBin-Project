        ...
        <div class="card text-white bg-dark shadow " style="background-color: #1c1e22;">
          <div class="card-body" style="background-color: #1c1e22;">
            <div class="row no-gutters align-items-center">
              <div class="mr-2">
                <div class="text-xs font-weight-bold text-uppercase mb-1"><span style="color: pink;">Welcome</span></div>
                <div class="h5 mb-0 font-weight-bold text-gray-800">21Pastes - Public Pastes</div>
              </div>
            </div>
          </div>
        </div>
...
$query = $connection->query('SELECT * FROM `tbl_pastes`');
$_SESSION["post"] = 2;
...
?>
            ...
            <a href="text/<?=$result["PID"]?>" <p class="text-justify"><?= "[" . $result["timestamp"] . "] " .$result["title"]?></p></a>
            <hr class="p-0 m-0">
<?php
}
?>
